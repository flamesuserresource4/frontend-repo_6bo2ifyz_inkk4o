  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 to-orange-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        <Link to="/" className="text-sm text-neutral-600 hover:text-neutral-900">← Back to collection</Link>
        <div className="mt-6 grid md:grid-cols-2 gap-10 items-start">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
            <h1 className="text-3xl md:text-5xl font-bold tracking-tight text-neutral-900">{item.name}</h1>
            ...
            <div className="mt-8 flex items-center gap-3">
              ...
              <button className="rounded-full border px-6 py-3 text-sm font-medium hover:bg-neutral-50 transition">Save</button>
            </div>
          </motion.div>
        </div>
      </div>
